...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::describe::WasmDescribe
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::IntoWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::OptionIntoWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::FromWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::OptionFromWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::RefFromWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::LongRefFromWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::VectorIntoWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::VectorFromWasmAbi
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::describe::WasmDescribeVector
for SomeGenericType<T, E> {
    fn describe_vector() {
        ::wasm_bindgen_utils::prelude::wasm_bindgen::describe::inform(
            ::wasm_bindgen_utils::prelude::wasm_bindgen::describe::VECTOR,
...
impl<T, E> From<SomeGenericType<T, E>> for ::wasm_bindgen_utils::prelude::JsValue
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
{
    fn from(value: SomeGenericType<T, E>) -> Self {
        let mut err = String::new();
        err.push_str(<SomeGenericType<T, E>>::TYPE_NAME);
        err.push_str(": ");
        let result = value.try_into_js_value();
        ::wasm_bindgen_utils::prelude::UnwrapThrowExt::expect_throw(
            result.inspect_err(|e| err.push_str(&e.to_string())),
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::convert::TryFromJsValue
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
...
impl<T, E> ::wasm_bindgen_utils::prelude::wasm_bindgen::__rt::VectorIntoJsValue
for SomeGenericType<T, E>
where
    T: serde::Serialize + for<'de> serde::Deserialize<'de>,
    E: serde::Serialize + for<'de> serde::Deserialize<'de>,
